...
document.getElementById("next").innerHTML="Sketch To be Drawn: " + sketch;
function preload(){
...
function gotResult(error, results){
    ...
    document.getElementById("accuracy").innerHTML="Confidence : " + Math.floor(results[0].confidence*100) + " % ";
...
function check_sketch(){
   timer_counter+=1;
   document.getElementById("timer").innerHTML="Text : " + timer_counter;
